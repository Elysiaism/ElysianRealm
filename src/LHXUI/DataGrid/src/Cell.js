...
function Cell({value, column, cellId, utility, anchorRef}) {
    ...
    switch (column.type) {
        case 'Text':
            return (
                <Input
                    className='LHXUI-DataGrid-Cell-Wrapper'
                    type='text'
                    value={value}
                    disableUnderline
            ...
            return (
                <>
                    ...
                    <Popover
                        ...
                        onClose={onInactive}
                    >
                        <Paper className='LHXUI-DataGrid-Selector'>
                            <Input
                                fullWidth
                                endAdornment={
                                    <InputAdornment>
...
function HeaderCell({cell, columnId, utility, disableProperty}) {
    ...
    return (
        <div
            className='LHXUI-DataGrid-Cell LHXUI-DataGrid-TH'
            ref={anchorRef}
        >
            <ToggleButton
                variant='text'
            ...
            <Popover
                className='LHXUI-DataGrid-Column-Property'
                open={menuOn}
                anchorEl={anchorRef.current}
                anchorOrigin={{
                    vertical: 'bottom',
                    ...
                    disableProperty ?
                        ...
                        <>
                            ...
                            <MenuItem
                                disableRipple
                                disableTouchRipple
                                className={'LHXUI-DataGrid-Column-Property-Form'}
                                sx={{
...
function DataCell({value, column, cellId, utility}) {
    ...
    return (
        <div
            className='LHXUI-DataGrid-Cell LHXUI-DataGrid-TD'
            ref={anchorRef}
        >
            <Cell
                value={value}
